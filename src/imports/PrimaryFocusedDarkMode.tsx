import svgPaths from "./svg-cmowoubr8o";
...
function Content() {
  return (
    <div className="bg-[#384857] h-[36px] relative rounded-[4px] shrink-0 w-full" data-name="content">
...
export default function PrimaryFocusedDarkMode() {
  return (
    <div className="content-stretch flex flex-col items-start relative size-full" data-name="Primary Focused - Dark mode">
      <Content />
    </div>
  );
}