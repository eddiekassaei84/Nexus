import svgPaths from "./svg-gbrt9fhojb";
...
function Content() {
  return (
    <div className="bg-[#c3c7cc] h-[36px] relative rounded-[4px] shrink-0" data-name="content">
...
export default function SecondaryFocused() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative size-full" data-name="Secondary Focused">
      <Content />
    </div>
  );
}