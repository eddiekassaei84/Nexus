import svgPaths from "./svg-asgatr96e1";
import { imgGroup } from "./svg-71u6a";
...
function Container2() {
  return (
    <div className="content-stretch flex h-[36px] items-center justify-between p-[10px] relative shrink-0 w-[320px]" data-name="Container">
      <TextInput />
      <Text />
    </div>
  );
  ...
  return (
    <div className="absolute left-[16px] size-[14px] top-[11px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g clipPath="url(#clip0_2181_17856)" id="Icon">
          <path d={svgPaths.pdd75d00} fill="var(--fill-0, white)" id="Vector" />
        </g>
        <defs>
          <clipPath id="clip0_2181_17856">
...
function Button() {
  return (
    <div className="bg-[#ff4d00] h-[36px] relative rounded-[4px] shrink-0 w-[149.094px]" data-name="Button">
      <Icon />
      <p className="-translate-x-1/2 absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-[85px] not-italic text-[14px] text-center text-white top-[7.5px] whitespace-nowrap">+ Add to Team</p>
    </div>
  );
}
...
function Toolbar() {
  return (
    <div className="bg-[#fafafa] h-[50px] relative shrink-0 w-full" data-name="Toolbar">
      <div aria-hidden="true" className="absolute border-[#f0f0f0] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between pb-px px-[12px] relative size-full">
          <Container1 />
          <Container3 />
        </div>
      </div>
...
function Container6() {
  return <div className="absolute h-[47px] left-[813px] top-0 w-[60px]" data-name="Container" />;
}
...
function HeaderCell2() {
  return (
    <div className="absolute bg-[#fafafa] content-stretch flex h-[47px] items-center left-[528px] overflow-clip pl-[8px] top-0 w-[285px]" data-name="HeaderCell">
      <Text3 />
    </div>
  );
}
...
function Container4() {
  return (
    <div className="bg-[#fafafa] h-[48px] relative shrink-0 w-[873px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#f0f0f0] border-b border-solid inset-0 pointer-events-none" />
      <Container5 />
      <Container6 />
      <HeaderCell />
...
function Text7() {
  return (
    <div className="absolute content-stretch flex h-[19.5px] items-start left-[528px] overflow-clip top-[13.75px] w-[269px]" data-name="Text">
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_2181_17853)" id="Icon">
          <path d={svgPaths.p7115580} fill="var(--fill-0, #616D79)" id="Vector" />
        </g>
        <defs>
          <clipPath id="clip0_2181_17853">
...
function Container13() {
  return (
    <div className="absolute content-stretch flex h-[32px] items-center justify-center left-[813px] top-[7.5px] w-[60px]" data-name="Container">
      <RemoveIconBtn />
    </div>
  );
}
...
function Container42() {
  return (
    <div className="bg-[#f0f2f5] flex-[1_0_0] h-[28px] min-h-px min-w-px relative rounded-[6px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <Icon18 />
      </div>
    </div>
...
function Container7() {
  return (
    <div className="bg-white content-stretch flex flex-col h-[542px] items-start overflow-clip relative shrink-0 w-[873px]" data-name="Container">
      <Container8 />
      <Container14 />
      <Container20 />
      <Container26 />
