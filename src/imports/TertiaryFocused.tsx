import svgPaths from "./svg-8c0gzmzi07";
    ...
    <div className="relative size-full">
      <div className="absolute inset-[-5%_-5%_-5%_0]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.75 16.5">
          <g id="Group 8">
            <path d={svgPaths.p18c7ece0} id="Vector 64" stroke="var(--stroke-0, #616D79)" strokeLinejoin="round" strokeWidth="1.5" />
            <g id="Group 27">
              <path d="M1.31134e-07 8.25L12 8.25" id="Vector 8" stroke="var(--stroke-0, #616D79)" strokeWidth="1.5" />
              <path d="M9 11.25L12 8.25L9 5.25" id="Vector" stroke="var(--stroke-0, #616D79)" strokeWidth="1.5" />
            </g>
          </g>
        </svg>
      </div>
...
function Content() {
  return (
    <div className="bg-[#c3c7cc] content-stretch flex gap-[4px] h-[36px] items-center justify-center overflow-clip px-[16px] relative rounded-[4px] shrink-0" data-name="content">
            ...
            <div className="relative size-full" data-name="Vector">
              <div className="absolute inset-[-11.79%_-23.57%]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6.62132 11.1213">
                  <path d={svgPaths.p291da40} id="Vector" stroke="var(--stroke-0, #616D79)" strokeLinecap="square" strokeWidth="1.5" />
                </svg>
              </div>
            </div>
          </div>
...
export default function TertiaryFocused() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative size-full" data-name="Tertiary Focused">
      <Content />
    </div>
  );
}