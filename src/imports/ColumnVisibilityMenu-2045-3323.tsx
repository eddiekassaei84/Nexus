import svgPaths from "./svg-sx1emvnyv1";
  ...
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Container">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between pl-[17px] pr-[16px] relative w-full">
          <Container1 />
          <Group1 />
        </div>
      </div>
...
function Span1() {
  return (
    <div className="h-[20px] opacity-70 relative shrink-0 w-[38.837px]" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#262626] text-[14px] top-[0.11px] whitespace-pre">{`Freeze  up to column:`}</p>
      </div>
    </div>
  );
}
...
function MasterInputNoLabelLargeTextOnly() {
  return (
    <div className="bg-white h-[32px] relative rounded-[4px] shrink-0 w-full" data-name="master/input/no-label/large/text-only">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[12px] relative size-full">
          <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#595959] text-[0px] text-center w-[24px]">
            <p className="font-['Inter:Bold',sans-serif] font-bold leading-[20px] text-[14px]">01</p>
          </div>
        </div>
      </div>
    </div>
...
function InputFieldMedium48NormalNoIconFilled() {
  return (
    <div className="col-1 content-stretch flex flex-col items-start ml-0 mt-0 relative row-1 size-[32px]" data-name="Input Field/medium-48/normal/no-icon/filled">
      <MasterInputNoLabelLargeTextOnly />
    </div>
  );
}
...
function Minus() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center justify-center p-[12px] relative rounded-bl-[4px] rounded-tl-[4px] shrink-0 size-[32px]" data-name="Minus">
      <div aria-hidden="true" className="absolute border-[#d9d9d9] border-r border-solid inset-[0_-1px_0_0] pointer-events-none rounded-bl-[4px] rounded-tl-[4px]" />
      <div className="overflow-clip relative shrink-0 size-[24px]" data-name="24px/suggested/minus">
        <div className="absolute bottom-1/2 left-[16.67%] right-[16.67%] top-1/2">
          <div className="absolute inset-[-0.75px_-4.69%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.5 1.5">
              <path d="M0.75 0.75H16.75" id="Vector 19" stroke="var(--stroke-0, #616D79)" strokeLinecap="square" strokeWidth="1.5" />
            </svg>
          </div>
        </div>
      </div>
      <div className="absolute inset-[0_-1px_0_0] pointer-events-none rounded-[inherit] shadow-[inset_1px_0px_0px_0px_#d9d9d9,inset_0px_1px_0px_0px_#d9d9d9,inset_0px_-1px_0px_0px_#d9d9d9]" />
    </div>
  );
}
    ...
    <div className="absolute inset-[16.67%]">
      <div className="absolute inset-[-4.69%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.5 17.5">
          <g id="Group 33">
            <path d="M0.75 8.75H16.75" id="Vector 19" stroke="var(--stroke-0, #616D79)" strokeLinecap="square" strokeWidth="1.5" />
            <path d="M8.75 0.75L8.75 16.75" id="Vector 20" stroke="var(--stroke-0, #616D79)" strokeLinecap="square" strokeWidth="1.5" />
          </g>
        </svg>
      </div>
    </div>
...
function Plus() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center justify-center p-[12px] relative rounded-br-[4px] rounded-tr-[4px] shrink-0 size-[32px]" data-name="Plus">
      <div className="overflow-clip relative shrink-0 size-[24px]" data-name="24px/suggested/plus">
        <Group />
      </div>
...
function MasterInputNumberHorizontalControlsDefault() {
  return (
    <div className="bg-[#f5f5f5] content-stretch flex gap-px h-[32px] items-center justify-end relative rounded-[4px] shrink-0" data-name="master/input-number/horizontal-controls/default">
      <Minus />
      <Plus />
    </div>
  );
...
function InputNumber() {
  return (
    <div className="col-1 content-stretch flex h-[32px] items-center ml-[48px] mt-0 relative row-1" data-name="Input Number">
      <MasterInputNumberHorizontalControlsDefault />
    </div>
  );
}
...
function Group2() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      <InputFieldMedium48NormalNoIconFilled />
      <InputNumber />
    </div>
  );
}
