import svgPaths from "./svg-kj1f4ddg7o";
...
function Content() {
  return (
    <div className="bg-[#616d79] h-[36px] relative rounded-[4px] shrink-0" data-name="content">
...
export default function SecondaryPressed() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative size-full" data-name="Secondary Pressed">
      <Content />
    </div>
  );
}