import svgPaths from "./svg-3s0i3rzcmr";
...
function Content() {
  return (
    <div className="bg-[#4c5a67] content-stretch flex gap-[4px] h-[36px] items-center justify-center overflow-clip px-[16px] relative rounded-[4px] shrink-0" data-name="content">
...
export default function PrimaryHoverDarkMode() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative size-full" data-name="Primary Hover- Dark mode">
      <Content />
    </div>
  );
}