import svgPaths from "./svg-b82n1s3hua";
...
export default function PrimaryDefaultDarkMode() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative size-full" data-name="Primary Default - Dark mode">
      <Content />
    </div>
  );
}