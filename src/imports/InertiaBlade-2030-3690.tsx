import svgPaths from "./svg-0ey0n29ml8";
...
import imgImg3 from "figma:asset/31f8f844c85bcb0a258ba9cd606404673764a826.png";
import imgImg4 from "figma:asset/5d8ef005878d70532e56964fc87a73ec8e9a828c.png";

function Span() {
  return (
    <div className="flex-[1_0_0] h-[26.007px] min-h-px min-w-px relative" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[26px] left-[36px] not-italic text-[#243746] text-[18px] text-center top-[-0.89px] whitespace-nowrap">Projects</p>
      </div>
    </div>
  );
}
...
function Div1() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[103.194px]" data-name="div">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[15.99px] relative size-full">
        <Span />
      </div>
    </div>
  );
...
function Div2() {
  return <div className="bg-[#ff4d00] h-[1.997px] shrink-0 w-[103.194px]" data-name="div" />;
}

function Button() {
  return (
    <div className="h-[47.986px] relative shrink-0 w-[103.194px]" data-name="button">
...
function Span1() {
  return (
    <div className="h-[26.007px] relative shrink-0 w-[75.417px]" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Inter:Regular',sans-serif] font-normal leading-[26px] left-[38.5px] not-italic text-[#243746] text-[18px] text-center top-[-0.89px] whitespace-nowrap">Archived</p>
      </div>
    </div>
  );
}
...
function Div3() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[107.396px]" data-name="div">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center pl-[15.99px] relative size-full">
        <Span1 />
      </div>
    </div>
  );
...
function Div4() {
  return <div className="h-[1.997px] shrink-0 w-[107.396px]" data-name="div" />;
}

function Button1() {
  return (
    <div className="h-[47.986px] relative shrink-0 w-[107.396px]" data-name="button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center relative size-full">
        <Div3 />
        <Div4 />
      </div>
...
function Span2() {
  return (
    <div className="h-[26.007px] relative shrink-0 w-[92.795px]" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Inter:Regular',sans-serif] font-normal leading-[26px] left-[46.5px] not-italic text-[#243746] text-[18px] text-center top-[-0.89px] whitespace-nowrap">Dashboard</p>
      </div>
    </div>
  );
}
...
function Div5() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[124.774px]" data-name="div">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center pl-[15.99px] relative size-full">
        <Span2 />
      </div>
    </div>
...
function Div6() {
  return <div className="h-[1.997px] shrink-0 w-[124.774px]" data-name="div" />;
}

function Button2() {
  return (
    <div className="h-[47.986px] relative shrink-0 w-[124.774px]" data-name="button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center relative size-full">
        <Div5 />
        <Div6 />
      </div>
...
function Container3() {
  return (
    <div className="absolute content-stretch flex h-[47.986px] items-end left-[72px] top-[23.99px] w-[335.365px]" data-name="Container">
      <Button />
      <Button1 />
      <Button2 />
    </div>
  ...
  return (
    <div className="relative shrink-0 size-[17.986px]" data-name="svg">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.9861 17.9861">
        <g id="svg">
          <path d={svgPaths.p197bb8c0} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeWidth="1.49884" />
        </g>
      </svg>
    </div>
  );
...
function Button3() {
  return (
    <div className="bg-[#616d79] relative rounded-bl-[4px] rounded-tl-[4px] shrink-0 size-[35.99px]" data-name="button">
      <div aria-hidden="true" className="absolute border-[#616d79] border-b-[1.111px] border-l-[1.111px] border-solid border-t-[1.111px] inset-0 pointer-events-none rounded-bl-[4px] rounded-tl-[4px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center pl-[1.111px] pr-[0.017px] py-[1.111px] relative size-full">
        <Svg />
      </div>
    </div>
  );
...
function Svg1() {
  return (
    <div className="relative shrink-0 size-[17.986px]" data-name="svg">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.9861 17.9861">
        <g id="svg">
          <path d={svgPaths.p2f9f8e00} id="Vector" stroke="var(--stroke-0, #616D79)" strokeWidth="1.49884" />
          <path d={svgPaths.pb40f800} id="Vector_2" stroke="var(--stroke-0, #616D79)" strokeWidth="1.49884" />
          <path d={svgPaths.p2baa1180} id="Vector_3" stroke="var(--stroke-0, #616D79)" strokeWidth="1.49884" />
          <path d={svgPaths.p33737500} id="Vector_4" stroke="var(--stroke-0, #616D79)" strokeWidth="1.49884" />
        </g>
      </svg>
    </div>
  );
...
function Button4() {
  return (
    <div className="bg-[#f2f3f4] relative shrink-0 size-[35.99px]" data-name="button">
      <div aria-hidden="true" className="absolute border-[#c3c7cc] border-b-[1.111px] border-l-[1.111px] border-solid border-t-[1.111px] inset-0 pointer-events-none" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center pl-[1.111px] pr-[0.017px] py-[1.111px] relative size-full">
        <Svg1 />
      </div>
    </div>
...
function Svg2() {
  return (
    <div className="relative shrink-0 size-[17.986px]" data-name="svg">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.9861 17.9861">
        <g clipPath="url(#clip0_2029_540)" id="svg">
          <path d={svgPaths.p21ef6980} id="Vector" stroke="var(--stroke-0, #616D79)" strokeLinejoin="round" strokeWidth="1.49884" />
          <path d={svgPaths.p2f045ec0} id="Vector_2" stroke="var(--stroke-0, #616D79)" strokeWidth="1.49884" />
        </g>
        <defs>
          <clipPath id="clip0_2029_540">
...
function Container4() {
  return (
    <div className="absolute content-stretch flex h-[35.99px] items-center left-[1630.26px] top-[28px] w-[107.969px]" data-name="Container">
      <Button3 />
      <Button4 />
      <Button5 />
    </div>
...
function Container2() {
  return (
    <div className="h-[73.09px] relative shrink-0 w-full" data-name="Container">
...
function Container7() {
  return (
    <div className="absolute bg-[#f7f7f8] content-stretch flex h-[48px] items-center justify-between left-px pb-[1.111px] px-[11.997px] top-[0.92px] w-[1736px]" data-name="Container">
...
function Container98() {
  return (
    <div className="bg-[#c4c4c4] relative shrink-0 size-[40px]" data-name="Container">
...
function Container111() {
  return (
    <div className="absolute bg-white h-[54.878px] left-[1673.59px] top-[47.99px] w-[62.412px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-b-[1.11px] border-solid inset-0 pointer-events-none" />
    </div>
  );
}
...
function Container139() {
  return <div className="content-stretch flex h-[46.875px] items-center justify-center pr-[0.017px] shrink-0 w-[47.986px]" data-name="Container" />;
}
...
function Container140() {
  return (
    <div className="content-stretch flex items-center overflow-clip px-[8px] relative shrink-0 w-[420px]" data-name="Container">
      <Span90 />
      <Container141 />
    </div>
  );
...
function Container143() {
  return (
    <div className="h-[47px] overflow-clip relative shrink-0 w-[240px]" data-name="Container">
      <Span91 />
      <Container144 />
    </div>
  );
...
function Container149() {
  return (
    <div className="h-[47px] overflow-clip relative shrink-0 w-[300px]" data-name="Container">
      <Span93 />
      <Container150 />
    </div>
  );
...
function Container155() {
  return (
    <div className="h-[47px] overflow-clip relative shrink-0 w-[241px]" data-name="Container">
      <Span95 />
      <Container156 />
    </div>
  );
...
function Container11() {
  return (
    <div className="absolute h-[732px] left-px overflow-clip top-[48.92px] w-[1736px]" data-name="Container">
      <Container12 />
      <Container24 />
      <Container36 />
      <Container48 />
...
function Container5() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[1762px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start pt-[11.997px] px-[11.997px] relative size-full">
        <Container6 />
      </div>
    </div>
  );
...
function Container1() {
  return (
    <div className="bg-white flex-[1_0_0] h-[945.122px] min-h-px min-w-px relative" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <Container2 />
        <Container5 />
      </div>
...
function Container() {
  return (
    <div className="absolute bg-[#f2f3f4] content-stretch flex h-[945.122px] items-start left-0 top-[55.99px] w-[1762.222px]" data-name="Container">
      <Container1 />
    </div>
  );
}
...
function Svg24() {
  return (
    <div className="h-[55.99px] overflow-clip relative shrink-0 w-full" data-name="svg">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 171.997 55.9896">
        <path d={svgPaths.p1a31e100} fill="var(--fill-0, #243746)" id="Vector" />
      </svg>
      <div className="absolute inset-[14.29%_78.13%_14.29%_10.76%]" data-name="Vector">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19.1157 39.9926">
          <path d={svgPaths.p3b9dcb00} fill="var(--fill-0, white)" id="Vector" />
        </svg>
      </div>
      <div className="absolute inset-[35.14%_61.69%_35.14%_27.34%]" data-name="Vector">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18.8588 16.6347">
          <path d={svgPaths.p2fea6f80} fill="var(--fill-0, #FF4D00)" id="Vector" />
        </svg>
      </div>
      <div className="absolute inset-[35.14%_50.29%_35.14%_40.02%]" data-name="Vector">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16.661 16.6347">
          <path d={svgPaths.p2196b480} fill="var(--fill-0, #FF4D00)" id="Vector" />
        </svg>
      </div>
      <div className="absolute inset-[35.14%_35.76%_35.14%_50.09%]" data-name="Vector">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24.3421 16.6347">
          <path d={svgPaths.p303cfa00} fill="var(--fill-0, #FF4D00)" id="Vector" />
        </svg>
      </div>
      <div className="absolute inset-[35.14%_22.43%_35.14%_65.14%]" data-name="Vector">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 21.3876 16.6347">
          <path d={svgPaths.p2ecd11c0} fill="var(--fill-0, #FF4D00)" id="Vector" />
        </svg>
      </div>
      <div className="absolute inset-[35.14%_10.76%_35.14%_79.3%]" data-name="Vector">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.1097 16.6347">
          <path d={svgPaths.p1e5ab900} fill="var(--fill-0, #FF4D00)" id="Vector" />
        </svg>
      </div>
    </div>
  );
...
function Container163() {
  return (
    <div className="absolute content-stretch flex flex-col h-[55.99px] items-start left-0 top-0 w-[171.997px]" data-name="Container">
      <Svg24 />
    </div>
  );
}
...
function Container162() {
  return (
    <div className="h-[55.99px] relative shrink-0 w-[171.997px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Container163 />
      </div>
    </div>
...
function Button34() {
  return (
    <div className="relative rounded-[4px] shrink-0 size-[40px]" data-name="button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <Svg25 />
      </div>
    </div>
...
function Svg26() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="svg">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_2029_533)" id="svg">
          <path d={svgPaths.p3b27f100} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.25" />
          <path d={svgPaths.p3519fc80} id="Vector_2" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.25" />
        </g>
        <defs>
          <clipPath id="clip0_2029_533">
...
function Container165() {
  return (
    <div className="bg-black h-[43.993px] relative rounded-[4px] shrink-0 w-[200px]" data-name="Container">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[11.997px] items-center px-[7.101px] py-[1.111px] relative size-full">
        <Container166 />
        <Container167 />
      </div>
    </div>
...
function Container164() {
  return (
    <div className="h-[55.99px] relative shrink-0 w-[295.972px]" data-name="Container">
...
function Container161() {
  return (
    <div className="absolute bg-[#243746] content-stretch flex h-[55.99px] items-center justify-between left-0 pr-[11.997px] top-0 w-[1762.222px]" data-name="Container">
      <Container162 />
      <Container164 />
    </div>
  );
...
function Div() {
  return (
    <div className="absolute bg-[#f5f5f5] h-[1001.111px] left-0 overflow-clip top-0 w-[1762.222px]" data-name="div">
      <Container />
      <Container161 />
    </div>
  );
...
export default function InertiaBlade() {
  return (
    <div className="bg-white relative size-full" data-name="Inertia Blade">
      <Div />
    </div>
  );
}