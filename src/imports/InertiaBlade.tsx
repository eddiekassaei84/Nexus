import svgPaths from "./svg-0p5cz1y2zm";
...
import imgImg4 from "figma:asset/31f8f844c85bcb0a258ba9cd606404673764a826.png";
import imgImg5 from "figma:asset/5d8ef005878d70532e56964fc87a73ec8e9a828c.png";
  ...
  return (
    <div className="relative shrink-0 size-[17.986px]" data-name="svg">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.9861 17.9861">
        <g id="svg">
          <path d={svgPaths.p197bb8c0} id="Vector" stroke="var(--stroke-0, #616D79)" strokeLinecap="round" strokeWidth="1.49884" />
        </g>
      </svg>
    </div>
  );
...
function Button3() {
  return (
    <div className="bg-[#f2f3f4] relative rounded-bl-[4px] rounded-tl-[4px] shrink-0 size-[35.99px]" data-name="button">
...
function Svg1() {
  return (
    <div className="relative shrink-0 size-[17.986px]" data-name="svg">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.9861 17.9861">
        <g id="svg">
          <path d={svgPaths.p2f9f8e00} id="Vector" stroke="var(--stroke-0, white)" strokeWidth="1.49884" />
          <path d={svgPaths.pb40f800} id="Vector_2" stroke="var(--stroke-0, white)" strokeWidth="1.49884" />
          <path d={svgPaths.p2baa1180} id="Vector_3" stroke="var(--stroke-0, white)" strokeWidth="1.49884" />
          <path d={svgPaths.p33737500} id="Vector_4" stroke="var(--stroke-0, white)" strokeWidth="1.49884" />
        </g>
      </svg>
    </div>
  );
...
function Button4() {
  return (
    <div className="bg-[#616d79] relative shrink-0 size-[35.99px]" data-name="button">
      <div aria-hidden="true" className="absolute border-[#616d79] border-b-[1.111px] border-l-[1.111px] border-solid border-t-[1.111px] inset-0 pointer-events-none" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center pl-[1.111px] pr-[0.017px] py-[1.111px] relative size-full">
        <Svg1 />
      </div>
    </div>
...
function Container11() {
  return (
    <div className="absolute grid grid-cols-[repeat(1,minmax(0,1fr))] grid-rows-[repeat(1,minmax(0,1fr))] h-[733px] left-px overflow-clip pt-[24px] px-[24px] top-[48.92px] w-[1736px]" data-name="Container">
      <Container12 />
    </div>
  );
}
...
function Img4() {
  return (
    <div className="h-[25.99px] relative shrink-0 w-[135.816px]" data-name="img">
      <img alt="" className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImg4} />
    </div>
  );
}
