import svgPaths from "./svg-iyd2949br9";
...
function Content() {
  return (
    <div className="bg-[#e5e7e9] h-[36px] relative rounded-[4px] shrink-0" data-name="content">
...
export default function SecondaryHover() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative size-full" data-name="Secondary Hover">
      <Content />
    </div>
  );
}