import svgPaths from "./svg-5eywy8327r";
...
function Content() {
  return (
    <div className="bg-[#d4380d] content-stretch flex gap-[4px] h-[36px] items-center justify-center overflow-clip px-[16px] relative rounded-[4px] shrink-0" data-name="content">
...
export default function PrimaryPressed() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative size-full" data-name="Primary Pressed">
      <Content />
    </div>
  );
}