import svgPaths from "./svg-m6jyjlpt5c";
...
function Content() {
  return (
    <div className="bg-[#75808b] content-stretch flex gap-[4px] h-[36px] items-center justify-center overflow-clip px-[16px] relative rounded-[4px] shrink-0" data-name="content">
...
export default function PrimaryPressedDarkMode() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative size-full" data-name="Primary Pressed - Dark mode">
      <Content />
    </div>
  );
}