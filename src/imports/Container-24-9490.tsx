import svgPaths from "./svg-hk4l0szw5g";
...
function Favicon() {
  return (
    <div className="bg-[#dde9ff] overflow-clip relative rounded-[160px] shrink-0 size-[160px]" data-name="Favicon">
      <p className="-translate-x-1/2 absolute font-['Outfit:SemiBold',sans-serif] font-semibold leading-[18px] left-[calc(50%+0.5px)] text-[#465fff] text-[72px] text-center top-[calc(50%-9px)]">AR</p>
    </div>
  );
}
    ...
    <div className="flex-[1_0_0] min-h-px min-w-px relative" data-name="Text Wrapper">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center px-[16px] relative w-full">
          <div className="flex flex-[1_0_0] flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] min-h-px min-w-px not-italic overflow-hidden relative text-[14px] text-[rgba(0,0,0,0.88)] text-ellipsis whitespace-nowrap">
...
function BodyCell() {
  return (
    <div className="absolute bg-white h-[17px] left-[187px] top-[38px] w-[205px]" data-name="Body-Cell">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
...
function BodyCell1() {
  return (
    <div className="absolute bg-white content-stretch flex h-[40px] items-center left-[187px] overflow-clip py-[16px] top-[52px] w-[205px]" data-name="Body-Cell">
      <TextWrapper1 />
    </div>
  );
}
...
function Content() {
  return (
    <div className="bg-[#ecf3ff] content-stretch flex gap-[8px] h-[24px] items-center justify-center px-[16px] relative rounded-[40px] shrink-0 w-[112px]" data-name="content">
      <div className="flex items-center justify-center relative shrink-0">
        <div className="-scale-y-100 flex-none rotate-180">
          <div className="relative size-[4px]" data-name="02 Shapes / Circle">
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 4 4">
              <circle cx="2" cy="2" fill="var(--fill-0, #0099FF)" id="Ellipse 12" r="2" />
            </svg>
          </div>
        </div>
      </div>
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#09f] text-[10px] whitespace-nowrap">
        <p className="leading-[20px]">Pending invitation</p>
      </div>
    </div>
  );
}
...
function Pill() {
  return (
    <div className="absolute content-stretch flex h-[44px] items-center justify-center left-[193px] top-[120px]" data-name="Pill">
      <Content />
    </div>
  );
}
  ...
  return (
    <div className="bg-[rgba(0,0,0,0)] relative shrink-0 w-full" data-name="Search">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col gap-[10px] items-start justify-center p-[12px] relative w-full">
          <Favicon />
          <BodyCell />
          <BodyCell1 />
          <Pill />
  ...
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative" data-name="Text Wrapper">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center px-[16px] relative w-full">
          <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px not-italic overflow-hidden relative text-[14px] text-[rgba(0,0,0,0.88)] text-ellipsis whitespace-nowrap">
            <p className="leading-[normal] overflow-hidden">First Name</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative" data-name="Text Wrapper">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center px-[16px] relative w-full">
          <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px not-italic overflow-hidden relative text-[14px] text-[rgba(0,0,0,0.88)] text-ellipsis whitespace-nowrap">
            <p className="leading-[normal] overflow-hidden">Last Name</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative" data-name="Text Wrapper">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center px-[16px] relative w-full">
          <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px not-italic overflow-hidden relative text-[14px] text-[rgba(0,0,0,0.88)] text-ellipsis whitespace-nowrap">
            <p className="leading-[normal] overflow-hidden">Eddie</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative" data-name="Text Wrapper">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center px-[16px] relative w-full">
          <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px not-italic overflow-hidden relative text-[14px] text-[rgba(0,0,0,0.88)] text-ellipsis whitespace-nowrap">
            <p className="leading-[normal] overflow-hidden">Kassaei</p>
          </div>
        </div>
      </div>
    </div>
...
function ColumnText2() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-[146px]" data-name="Column / Text">
      <BodyCell24 />
      <BodyCell25 />
    </div>
  );
...
function BodyCell26() {
  return (
    <div className="bg-white h-[40px] relative shrink-0 w-full" data-name="Body-Cell">
      <div className="content-stretch flex items-center overflow-clip py-[16px] relative rounded-[inherit] size-full">
        <TextWrapper26 />
      </div>
      <div aria-hidden="true" className="absolute border-[#dbdbdb] border-b border-solid inset-0 pointer-events-none" />
...
function ColumnText3() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-[263px]" data-name="Column / Text">
      <BodyCell26 />
      <BodyCell27 />
    </div>
  );
