import svgPaths from "./svg-jckjyqz6g8";
...
function Content() {
  return (
    <div className="bg-[#e5e7e9] content-stretch flex gap-[4px] h-[36px] items-center justify-center overflow-clip px-[16px] relative rounded-[4px] shrink-0" data-name="content">
...
export default function TertiaryHover() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative size-full" data-name="Tertiary Hover">
      <Content />
    </div>
  );
}