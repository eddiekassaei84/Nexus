import svgPaths from "./svg-172c8w22ag";
...
function MasterProgressStandardStrokeRoundDefault() {
  return (
    <div className="-translate-y-1/2 absolute h-[8px] left-0 right-[42px] top-1/2" data-name="master/progress/standard/stroke-round/default">
      ...
      <div className="-translate-y-1/2 absolute flex h-[8px] items-center justify-center left-0 right-0 top-1/2">
        <div className="-scale-y-100 flex-none h-[8px] rotate-180 w-[478px]">
