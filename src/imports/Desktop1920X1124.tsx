import svgPaths from "./svg-fynbzyrtwq";
...
import { imgShutterstock6856549541 } from "./svg-jizvb";

function Group3() {
  return (
    <div className="absolute inset-[18.75%_12.5%_61.72%_12.5%]">
      <div className="absolute inset-[-21.33%_0]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 6.6875">
          <g id="Group 28">
            <path d="M9.00001 3.34375L18 3.34375" id="Vector 15" stroke="var(--stroke-0, #FF4D00)" strokeWidth="2" />
            <path d={svgPaths.p1b3ea700} id="Vector 16" stroke="var(--stroke-0, #FF4D00)" strokeWidth="2" />
            <ellipse cx="4.49995" cy="3.34375" id="Ellipse 9" rx="2.25" ry="2.34375" stroke="var(--stroke-0, #FF4D00)" strokeWidth="2" />
          </g>
        </svg>
      </div>
    </div>
...
function Group5() {
  return (
    <div className="relative size-full">
      <div className="absolute inset-[-21.33%_0]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.9998 6.6875">
          <g id="Group 30">
            <path d={svgPaths.p330f2a00} id="Vector 15" stroke="var(--stroke-0, #FF4D00)" strokeWidth="2" />
            <path d={svgPaths.p30330500} id="Vector 16" stroke="var(--stroke-0, #FF4D00)" strokeWidth="2" />
            <ellipse cx="4.49989" cy="3.34375" id="Ellipse 9" rx="2.25" ry="2.34375" stroke="var(--stroke-0, #FF4D00)" strokeWidth="2" />
          </g>
        </svg>
      </div>
    </div>
...
function Group4() {
  return (
    <div className="absolute contents inset-[18.75%_12.5%]">
      <Group3 />
      <div className="absolute flex inset-[61.72%_12.5%_18.75%_12.5%] items-center justify-center">
        <div className="flex-none h-[6.25px] rotate-180 w-[24px]">
          <Group5 />
        </div>
      </div>
    </div>
...
function LeftContent1() {
  return (
    <div className="content-stretch flex flex-col items-start min-w-[56px] px-[4px] relative shrink-0" data-name="Left Content">
      <div className="overflow-clip relative shrink-0 size-[24px]" data-name="32px/app/control">
        <Group4 />
      </div>
    </div>
  );
...
function ListItemText() {
  return (
    <div className="content-stretch flex flex-col items-start py-[4px] relative shrink-0 w-[221px]" data-name="ListItem Text">
...
function Files() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative" data-name="Files">
      <ListItem />
    </div>
  );
}
...
function Divider() {
  return (
    <div className="content-stretch flex flex-col h-[52px] items-center justify-center overflow-clip py-[4px] relative shrink-0 w-[2.548px]" data-name="Divider">
      <DividerLine />
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="content-stretch flex items-start relative shrink-0 w-[280px]">
      <Files />
      <Divider />
    </div>
  );
...
function Component24PxAppList() {
  return (
    <div className="pointer-events-none relative rounded-[4px] shrink-0 size-[48px]" data-name="24px/app/list">
      <img alt="" className="absolute inset-0 max-w-none object-cover rounded-[4px] size-full" src={img24PxAppList} />
      <div aria-hidden="true" className="absolute border border-[#75808b] border-solid inset-0 rounded-[4px]" />
    </div>
  );
}
...
function HeaderTitleContainer() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-[158px]" data-name="Header Title Container">
      <div className="flex flex-col font-['DM_Sans:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#f2f3f4] text-[16px] w-[358px]" style={{ fontVariationSettings: "'opsz' 14" }}>
        <p className="leading-[24px] whitespace-pre-wrap">Cleavland Hospital</p>
      </div>
    </div>
  );
}
...
function RightIcons() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-[552px]" data-name="Right Icons">
...
function Frame1() {
  return (
    <div className="content-stretch flex gap-[24px] items-center relative shrink-0 w-[876px]">
      <Frame2 />
      <Component24PxAppList />
      <RightIcons />
    </div>
  );
}
    ...
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center px-[16px] py-[8px] relative w-full">
          <LeftContent2 />
          <ListItemText1 />
          <div className="flex items-center justify-center relative shrink-0 size-[34px]" style={{ "--transform-inner-width": "1181", "--transform-inner-height": "21" } as React.CSSProperties}>
            <div className="flex-none rotate-90">
              <div className="content-stretch flex flex-col items-center justify-center overflow-clip p-[5px] relative rounded-[100px]" data-name="Right Action">
                <div className="overflow-clip relative shrink-0 size-[24px]" data-name="Icon">
                  <div className="absolute bottom-1/4 flex items-center justify-center left-[37.5%] right-[37.5%] top-1/4">
                    <div className="flex-none h-[12px] rotate-180 w-[6px]">
...
function Container2() {
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center pl-[64px] pr-[16px] py-[8px] relative w-full">
          <LeftContent4 />
          <ListItemText2 />
...
function Files1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Files">
      <ListItem3 />
    </div>
  );
}
...
function Container5() {
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center pr-[16px] py-[8px] relative w-full">
          <LeftContent10 />
          <ListItemText5 />
          <div className="content-stretch flex flex-col items-center justify-center overflow-clip p-[5px] relative rounded-[100px] shrink-0" data-name="Right Action">
            <div className="content-stretch flex items-start shrink-0" data-name="Icon" />
...
function LeftContent15() {
  return (
    <div className="content-stretch flex flex-col items-start min-w-[56px] px-[4px] relative shrink-0" data-name="Left Content">
      <div className="relative shrink-0 size-[24px]" data-name="oi:layers">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
          <path d={svgPaths.p1cccd200} fill="var(--fill-0, white)" id="Vector" />
        </svg>
      </div>
    </div>
  );
...
function Ul() {
  return (
    <div className="bg-[#243746] content-stretch flex flex-col gap-[4px] h-[1018px] items-start relative shrink-0 w-[280px]" data-name="ul">
      <List />
      <List1 />
      <Files1 />
      <Files2 />
...
function Avatar1() {
  return (
    <div className="relative rounded-[200px] shrink-0 size-[40px]" data-name="Avatar">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[200px] size-full" src={imgShutterstock6856549542} />
    </div>
  );
}
...
function Row4() {
  return (
    <div className="bg-[#f0f0f0] col-1 content-stretch flex h-[36px] items-center ml-0 mt-[12px] relative row-1 w-[1640px]" data-name="Row">
      <div aria-hidden="true" className="absolute border-[#d9d9d9] border-b border-solid inset-0 pointer-events-none" />
      <TableItemRowItem3 />
    </div>
  );
...
export default function Desktop1920X() {
  return (
    <div className="bg-[#f5f5f5] relative size-full" data-name="Desktop - 1920 x 1124">
