import svgPaths from "./svg-f8slhkhqgc";
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center min-h-px min-w-px relative">
      <div className="content-stretch flex flex-[1_0_0] items-center min-h-px min-w-px relative" data-name="Entry">
        <p className="flex-[1_0_0] font-['Actor:Regular',sans-serif] leading-[1.2] min-h-px min-w-px not-italic overflow-hidden relative text-[14px] text-black text-ellipsis whitespace-nowrap">#sagAfsfhasdjoas1jd</p>
      </div>
    </div>
  );
}
...
function Frame14() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center min-h-px min-w-px relative">
      <div className="content-stretch flex flex-[1_0_0] items-center min-h-px min-w-px relative" data-name="Entry">
        <p className="flex-[1_0_0] font-['Actor:Regular',sans-serif] leading-[1.2] min-h-px min-w-px not-italic overflow-hidden relative text-[14px] text-black text-ellipsis whitespace-nowrap">#sagAfsfhasdj1a1</p>
      </div>
    </div>
  );
}
...
function Frame3() {
  return (
    <div className="bg-white h-[40px] min-h-[40px] relative rounded-[4px] shrink-0 w-full">
      <div aria-hidden="true" className="absolute border border-[#f5222d] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <div className="flex flex-row items-center justify-end min-h-[inherit] size-full">
        <div className="content-stretch flex gap-[12px] items-center justify-end min-h-[inherit] pb-[11px] pt-[10px] px-[12px] relative size-full">
          <Frame14 />
          <div className="overflow-clip relative shrink-0 size-[24px]" data-name="32px/app/eye">
...
function Frame18() {
  return (
    <div className="content-stretch flex items-start relative shrink-0">
      <div className="flex flex-col font-['Open_Sans:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#f5222d] text-[12px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[13px]">Passwords must match.</p>
      </div>
    </div>
  );
}
...
export default function Resetpasswordvalidation() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-center overflow-clip py-[48px] relative rounded-tl-[24px] rounded-tr-[24px] size-full" data-name="resetpasswordvalidation">
      <Header />
      <Form />
    </div>
  );
