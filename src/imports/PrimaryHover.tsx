import svgPaths from "./svg-b9wzrpkfh6";
...
function Content() {
  return (
    <div className="bg-[#ff773e] content-stretch flex gap-[4px] h-[36px] items-center justify-center overflow-clip px-[16px] relative rounded-[4px] shrink-0" data-name="content">
...
export default function PrimaryHover() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative size-full" data-name="Primary Hover">
      <Content />
    </div>
  );
}