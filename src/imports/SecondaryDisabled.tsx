import svgPaths from "./svg-l57jqjp506";
...
function Content() {
  return (
    <div className="bg-[#f5f5f5] h-[36px] relative rounded-[4px] shrink-0" data-name="content">
...
export default function SecondaryDisabled() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative size-full" data-name="Secondary Disabled">
      <Content />
    </div>
  );
}