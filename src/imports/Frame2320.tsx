import svgPaths from "./svg-fa8ilxkdye";
...
function TextWrapper() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start not-italic pr-[8px] relative shrink-0 text-[#262626] w-[1257px]" data-name="Text Wrapper">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] min-w-full relative shrink-0 text-[16px] w-[min-content]">Delete Project</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-w-full relative shrink-0 text-[14px] w-[min-content]">Permanently remove this project and all associated data from the system. This action cannot be undone and should only be used when a project was created by mistake or must be fully erased.</p>
    </div>
  );
}
      ...
      <div className="relative shrink-0 size-[24px]" data-name="24px/suggested/info-circle-filled">
        <div className="absolute inset-[8.33%]" data-name="Subtract">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
            <path d={svgPaths.p93c9e00} fill="var(--fill-0, #F5222D)" id="Subtract" />
          </svg>
        </div>
      </div>
      <TextWrapper />
...
function Button() {
  return (
    <div className="bg-[#f5222d] content-stretch flex flex-col items-center justify-center px-[16px] relative rounded-[4px] shrink-0" data-name="Button">
      <div aria-hidden="true" className="absolute border border-[#ffa39e] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <Content1 />
    </div>
  );
}
...
function Banner() {
  return (
    <div className="bg-[#fff1f0] relative rounded-[4px] shrink-0 w-full" data-name="Banner">
