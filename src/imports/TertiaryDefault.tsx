import svgPaths from "./svg-pn8d98dzrw";
...
export default function TertiaryDefault() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative size-full" data-name="Tertiary Default">
      <Content />
    </div>
  );
}