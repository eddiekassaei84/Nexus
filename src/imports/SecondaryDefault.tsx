import svgPaths from "./svg-9bka2vcja2";
...
function Content() {
  return (
    <div className="bg-[#f2f3f4] h-[36px] relative rounded-[4px] shrink-0" data-name="content">
...
export default function SecondaryDefault() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative size-full" data-name="Secondary Default">
      <Content />
    </div>
  );
}