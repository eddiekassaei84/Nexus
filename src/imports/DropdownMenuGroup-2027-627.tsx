import svgPaths from "./svg-g9udykf021";
...
function CheckboxContainer() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 size-[24px]" data-name="Checkbox Container">
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="check">
        <div className="absolute bottom-[29.17%] left-[16.67%] right-[16.67%] top-1/4" data-name="Vector">
          <div className="absolute inset-[-13.64%_-9.37%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12.6667 9.33333">
              <path d={svgPaths.p332a3700} id="Vector" stroke="var(--stroke-0, #111111)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
            </svg>
          </div>
        </div>
      </div>
...
function DropdownMenuItem1() {
  return (
    <div className="bg-[#e6f7ff] h-[32px] relative shrink-0 w-full" data-name="Dropdown Menu Item">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[12px] py-[5px] relative size-full">
          <p className="flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[20px] min-h-px min-w-px not-italic relative text-[#384857] text-[14px]">Name ( A→ Z )</p>
          <CheckboxContainer />
        </div>
      </div>
    </div>
...
function DropdownMenuItem3() {
  return (
    <div className="bg-white h-[32px] relative shrink-0 w-full" data-name="Dropdown Menu Item">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[12px] py-[5px] relative size-full">
